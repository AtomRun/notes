...
来源：[廖雪峰博客](https://www.liaoxuefeng.com/wiki/1252599548343744/1264804593397984)
...
使用动态代理，JDK会帮我们自动生成实现类，而免去我们使用简单的代理模式，每个实现类做任何操作，并且Spring的AOP可以使得做方法增强

JDK的动态代理必须要目标接类有实现接口，如果没有就会使用CGlib代理CGlib使用的是继承的方式。